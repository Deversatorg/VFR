...
public sealed class ApplicationAuthFlowFactory : WebApplicationFactory<LoginHandler>
{
    private readonly string _databaseName = $"application-auth-flow-tests-{Guid.NewGuid():N}";
