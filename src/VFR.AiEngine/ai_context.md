...
### Pipeline A: Avatar Generation (`vfr_ai_engine/runtime/avatar/pipeline.py`)
...
### Pipeline B: Garment Generation (`vfr_ai_engine/runtime/garments/pipeline.py`)
...
- **Текущая задача:** Логика генерации SMPL-X (BMI to Betas) живет в `vfr_ai_engine/runtime/avatar/pipeline.py`; measurement math вынесена в `vfr_ai_engine/runtime/measurements/`.
